...
use crate::core::service::ControllerService;
...
/// Fallback handler
async fn not_implemented() -> ControllerError {
    ControllerError::NotImplemented
}
...
impl ControllerService for OpenAPIEndpoints {
    ...
    type ServiceError = ControllerError;
...
mod tests {
    ...
    use crate::core::traits::{Describe, Identity, IntoArc, IntoSensor};
